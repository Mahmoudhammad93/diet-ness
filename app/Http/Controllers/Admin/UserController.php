...
class UserController extends Controller
{
    ...
    {
        $users = User::where('user_type','user')->with('details')->latest()->paginate(30);
    ...
    {
        $user = User::where('id',$id)->with('addresses.area.city','details')->first();
        $subscriptions = Subscription::with('plan')->where('user_id',$user->id)->latest()->paginate(10);
