...
@section('content')
    <form action="{{ aurl('packages/plans/update/' . $plan->id) }}" enctype="multipart/form-data" method="POST">
        @csrf
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name_ar" value="{{ $plan->name_ar }}" class="form-control"
                            id="name_ar">
                    </div>
                    ...
                    <div class="form-group">
                        <label class="floating-label" for="name_en">{{ trans('admin.Name En') }} <span
                                class="redStar">*</span></label>
                        <input type="text" name="name_en" value="{{ $plan->name_en }}" class="form-control"
                            id="name_en">
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="floating-label" for="old_price">{{ trans('admin.Old Price') }} <span
                                    class="redStar">*</span></label>
                            <input type="number" value="{{ $plan->old_price }}" name="old_price" class="form-control"
                                id="old_price">
                        </div>
                        <div class="form-group col-md-6">
                            <label class="floating-label" for="new_price">{{ trans('admin.New Price') }} <span
                                    class="redStar">*</span></label>
                            <input type="number" value="{{ $plan->new_price }}" name="new_price" class="form-control"
                                id="new_price">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="floating-label" for="details_ar">{{ trans('admin.Details Ar') }} <span
                                class="redStar">*</span></label>
                        <textarea name="details_ar" rows="4" class="form-control" id="details_ar">{{ $plan->details_ar }}</textarea>
                    </div>

                    <div class="form-group">
                        <label class="floating-label" for="details_en">{{ trans('admin.Details En') }} <span
                                class="redStar">*</span></label>
                        <textarea name="details_en" rows="4" class="form-control" id="details_en">{{ $plan->details_en }}</textarea>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="floating-label" for="meal_name_ar">{{ trans('admin.Name Ar') }} <span
                                                class="redStar">*</span></label>
                                        <input type="text" name="meal_name_ar[]" value="{{ $meal->name_ar }}"
                                            class="form-control" id="meal_name_ar">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="floating-label" for="meal_name_en">{{ trans('admin.Name En') }}
                                            <span class="redStar">*</span></label>
                                        <input type="text" name="meal_name_en[]" value="{{ $meal->name_en }}"
                                            class="form-control" id="meal_name_en">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="floating-label"
                                            ...
                                            <span class="redStar">*</span></label>
                                        <input type="text" name="meal_details_ar[]" value="{{ $meal->details_ar }}"
                                            class="form-control" id="meal_details_ar">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="floating-label"
                                            for="meal_details_en">{{ trans('admin.Details En') }}
                                            <span class="redStar">*</span></label>
                                        <input type="text" name="meal_details_en[]" value="{{ $meal->details_en }}"
                                            class="form-control" id="meal_details_en">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="floating-label" for="meal_price">{{ trans('admin.Price') }} <span
                                                class="redStar">*</span></label>
                                        <input type="number" name="meal_price[]" value="{{ $meal->price }}"
                                            class="form-control" id="meal_price">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="floating-label" for="quantity">{{ trans('admin.Quantity') }} <span
                                                class="redStar">*</span></label>
                                        <input type="number" name="quantity[]" value="{{ $meal->quantity }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="floating-label" for="max">{{ trans('admin.Max') }} <span
                                                class="redStar">*</span></label>
                                        <input type="number" name="max[]" value="{{ $meal->max }}"
                                            class="form-control" id="max">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="floating-label" for="min">{{ trans('admin.Min') }} <span
                                                class="redStar">*</span></label>
                                        <input type="number" name="min[]" value="{{ $meal->min }}"
