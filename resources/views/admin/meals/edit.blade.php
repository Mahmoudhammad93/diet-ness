...
@section('content')
    <div class="col-md-12 col-xl-12">
        <div class="card">
            ...
            <form action="{{ aurl('meals/update/'.$meal->id) }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label class="floating-label" for="ar_name">{{ trans('admin.Name Ar') }} <span class="redStar">*</span></label>
                        <input type="text" name="ar_name" class="form-control" id="ar_name" value="{{$meal->ar_name}}">
                    </div>

                    <div class="form-group">
                        <label class="floating-label" for="en_name">{{ trans('admin.Name En') }} <span class="redStar">*</span></label>
                        <input type="text" name="en_name" class="form-control" id="en_name" value="{{$meal->en_name}}">
                    </div>
                </div>
