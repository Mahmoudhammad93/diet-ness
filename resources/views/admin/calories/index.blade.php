                            ...
                            <tbody>
                                @foreach ($calories as $calory)
                                    <tr>
                                        <td>{{ $calory->id }}</td>
                                        <td>{{ $calory->name }}</td>
                                        <td>{{ $calory->display_name }}</td>
                                        <td>{{ $calory->admins_count }}</td>
                                        <td data-toggle="tooltip" title="{{ $calory->description }}">
                                            {{ Str::limit($calory->description, 35) }}</td>
